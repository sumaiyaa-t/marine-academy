...
@section('content')
    <h4>Edit Achievement Contents</h4>
    <hr>
            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content_bn" id="" cols="30" rows="10"
                              ...
                              placeholder="Enter achievement content">{{ $achievement->content_bn }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content_en" id="" cols="30" rows="10"
                              ...
                              placeholder="Enter achievement content">{{ $achievement->content_en }}</textarea>
                </div>
                ...
                <div class="form-group">
                    <select class="form-control" aria-label="Default select example" name="tag">
                        <option value="partner" @if($achievement->tag =='partner') selected @endif>Partner</option>
                        <option value="achievement" @if($achievement->tag =='achievement') selected @endif>Achievement
                        </option>
                    </select>
                </div>
