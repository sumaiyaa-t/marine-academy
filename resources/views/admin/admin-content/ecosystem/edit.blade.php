            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('title_bn') is-invalid @enderror" value="{{ $ecosystem->title_bn }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('title_en') is-invalid @enderror" value="{{ $ecosystem->title_en }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content_bn" id="" cols="30" rows="10"
                              ...
                              placeholder="Enter achievement content">{{ $ecosystem->content_bn }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content_en" id="" cols="30" rows="10"
                              ...
                              placeholder="Enter achievement content">{{ $ecosystem->content_en }}</textarea>
                </div>
