...
@section('content')
    <h4>Edit Platform Contents</h4>
    <hr>

    <div>
        <form action="{{ route('platform.update',$platform->id) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            @method('put')
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('title_bn') is-invalid @enderror" value="{{ $platform->title_bn }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="exampleInputEmail1" aria-describedby="emailHelp"
                           ...
                           class="form-control @error('title_en') is-invalid @enderror" value="{{ $platform->title_en }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content_bn" id="" cols="30" rows="10"
                              ...
                              placeholder="Enter achievement content">{{ $platform->content_bn }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content_en" id="" cols="30" rows="10"
                              ...
                              placeholder="Enter achievement content">{{ $platform->content_en }}</textarea>
                </div>
